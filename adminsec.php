	...
	<div class="col-lg-12" style="top:10px;">
		...
		<?php } ?>
			<div class="col-md-12">
				<div class="card">
					<div class="card-header">
						<b>List of Members</b>
						<span class="float:right"><a class="btn btn-primary float-right btn-sm" data-bs-target="#new--member" data-bs-toggle="modal">
			...
			<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
				...
				<tbody>
					<?php
						$users = $conn->query("SELECT * FROM admin order by Member_id");
					...
					<tr class="text-center">
						...
						<td class="ri">
							<button class="btn btn-sm btn-info edit_member" data-id="<?php echo $row['Member_id'] ?>" type="button"> Edit </button>
							<button class="btn btn-sm btn-danger delete_member" type="button" data-bs-toggle="modal" data-bs-target="#deletemodal" data-id="<?php echo $row['Member_id'] ?>">Delete</button>
						</td>
					</tr>
					<?php endwhile; ?>
				</tbody>
  ...
  <div class="modal-dialog" role="document" style="margin: 5% 32%;">
    <div class="modal-content">
      ...
      <div class="modal-body">
		<form action="datahandle.php" method="POST" id="new-member" enctype="multipart/form-data">
			<div id="err"></div>	
            ...
            $.ajax({
				...
				success: function (response) {
					$.each(response,function(key,value)
					{
						...
						$('#edit_mid').attr('value',value['Member_id']);
						$('#editmid').attr('value',value['Member_id']);
